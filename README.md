...
|:---|:---|:---|
| Universidade Cidade de São Paulo (UNICID) | Bacharelado em Ciência da Computação | 2023 — 2026 |
...
- `/projeto-laboratorio-de-classificacao-visual/`: Laboratório de Classificação Visual — visão computacional e vieses algorítmicos.
- `/projeto-laboratorio-de-engenharia-reversa/`: Engenharia Reversa com IA — reconstrução Full-Stack assistida por IA generativa.
- `/projeto-do-clone-ao-produto-minimo-viavel-mvp/`: Do Clone ao MVP+ — evolução de protótipo para produto com Firebase.
